...
def current_for_phase_array_selfconsistent(max_num_iter,
                                           tol,
                                           L_y,
                                          L_z,
                                          L_sc_0,
    ...
    for i in range(0, phase_array.shape[0]):
        ...
        fmatrix, evals, evecs, ham, num_iter = solve_system_numba(max_num_iter=max_num_iter,
                                                                  tol=tol,
                                                                  junction=True,
                                                               L_x=system.L_x,
                                                               L_y=system.L_y,
        ...
        del system, fmatrix, evals, evecs, ham, num_iter

    return current_midle, phase_array

def calculate_current_for_phase_of_all_alpha_orientations(max_num_iter=1000,
                                                          tol=1e-4,
                                                          phase_array=np.linspace(0,2*np.pi,15),
    ...
    for i in range(len(alpha_array)):
        ...
        current_all[:,i], phase_array = current_for_phase_array_selfconsistent(max_num_iter=max_num_iter,
                                                                               tol=tol,
                                                                               L_y=30,
                                                                              L_z=30,
                                                                              L_sc_0=25,
...
def calculate_current_for_phase_of_all_alpha_given_theta_and_phi(max_num_iter=1000,
                                                                 tol=1e-4,
                                                                 phase_array=np.linspace(0, 2 * np.pi, 15),
                                                                  alpha_max=np.linspace(0, 1, 10),
                                                                  theta=0,
